...
const ProductsMainRow1 = ({ AddToCart, ModelBaskets, CardCounter }) => {
  const { getProductsByIdMain, updateProductClicked } = useProductsContext();
  const products = getProductsByIdMain();
...
export default ProductsMainRow1;
