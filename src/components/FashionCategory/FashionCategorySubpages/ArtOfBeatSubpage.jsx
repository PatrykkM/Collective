...
import ArtOfBeatSubpageProductsRow1 from "./Product/ArtOfBeatSubpageProductsRow1";
import ArtOfBeatSubpageProductsRow2 from "./Product/ArtOfBeatSubpageProductsRow2";

const ArtOfBeatSubpage = ({
  CounterBasket,
  DisplayNumber,
  AddToCart,
  CardCounter,
    ...
    <>
      ...
      <div className="w-4/5 lg:border-t-2 lg:border-LightBlack">
        <div className=" lg:flex justify-end items-end lg:pb-7   ">
          <ArtOfBeatSubpageProductsRow1
            AddToCart={AddToCart}
            CardCounter={CardCounter}
            ModelBaskets={ModelBaskets}
          />
        </div>
        <div className=" lg:flex justify-end items-end pb-9   ">
          <ArtOfBeatSubpageProductsRow2
            AddToCart={AddToCart}
            CardCounter={CardCounter}
            ModelBaskets={ModelBaskets}
          />
...
export default ArtOfBeatSubpage;
