...
const ClassicElegantFashionSubpageProductsRow2 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdClassicElegant2, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdClassicElegant2();
...
export default ClassicElegantFashionSubpageProductsRow2;
