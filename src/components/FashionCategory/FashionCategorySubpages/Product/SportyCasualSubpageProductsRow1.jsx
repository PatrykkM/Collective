...
const SportyCasualSubpageProductsRow1 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdSportyCasual1, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdSportyCasual1();
...
export default SportyCasualSubpageProductsRow1;
