...
const SummerFashionSubpageProductsRow1 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdSummerFashion1, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdSummerFashion1();
...
export default SummerFashionSubpageProductsRow1;
