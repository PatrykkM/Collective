...
const SummerFashionSubpageProductsRow2 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdSummerFashion2, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdSummerFashion2();
...
export default SummerFashionSubpageProductsRow2;
