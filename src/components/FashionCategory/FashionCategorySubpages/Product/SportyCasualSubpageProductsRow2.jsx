...
const SportyCasualSubpageProductsRow2 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdSportyCasual2, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdSportyCasual2();
...
export default SportyCasualSubpageProductsRow2;
