...
const ClassicElegantFashionSubpageProductsRow1 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdClassicElegant1, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdClassicElegant1();
...
export default ClassicElegantFashionSubpageProductsRow1;
