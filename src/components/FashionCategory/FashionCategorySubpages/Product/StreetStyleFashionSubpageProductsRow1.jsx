...
const StreetStyleFashionSubpageProductsRow1 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdStreetStyle1, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdStreetStyle1();
...
export default StreetStyleFashionSubpageProductsRow1;
