...
const ArtOfBeatSubpageProductsRow2 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdArtOfBeatRow2, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdArtOfBeatRow2();
...
export default ArtOfBeatSubpageProductsRow2;
