...
const RetroSubpageProductsRow2 = ({ AddToCart, ModelBaskets, CardCounter }) => {
  const { getProductsByIdRetro2, updateProductClicked } = useProductsContext();
  const products = getProductsByIdRetro2();
...
export default RetroSubpageProductsRow2;
