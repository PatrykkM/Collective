...
const ArtOfBeatSubpageProductsRow1 = ({
  AddToCart,
  ModelBaskets,
  CardCounter,
}) => {
  const { getProductsByIdArtOfBeatRow1, updateProductClicked } =
    useProductsContext();
  const products = getProductsByIdArtOfBeatRow1();
...
export default ArtOfBeatSubpageProductsRow1;
