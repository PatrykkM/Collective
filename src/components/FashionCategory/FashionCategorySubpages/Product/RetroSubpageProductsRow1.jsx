...
const RetroSubpageProductsRow1 = ({ AddToCart, ModelBaskets, CardCounter }) => {
  const { getProductsByIdRetro1, updateProductClicked } = useProductsContext();
  const products = getProductsByIdRetro1();
...
export default RetroSubpageProductsRow1;
