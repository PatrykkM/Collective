...
import RetroSubpageProductsRow1 from "./Product/RetroSubpageProductsRow1";
import RetroSubpageProductsRow2 from "./Product/RetroSubpageProductsRow2";

const RetroStyleFashionSubpage = ({
  CounterBasket,
  DisplayNumber,
  AddToCart,
  CardCounter,
...
export default RetroStyleFashionSubpage;
