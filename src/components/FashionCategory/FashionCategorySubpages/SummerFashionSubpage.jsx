...
import SummerFashionSubpageProductsRow1 from "./Product/SummerFashionSubpageProductsRow1";
import SummerFashionSubpageProductsRow2 from "./Product/SummerFashionSubpageProductsRow2";
    ...
    <>
      ...
      <div className="w-4/5 lg:border-t-2 lg:border-LightBlack">
        <div className=" lg:flex justify-end  items-end  lg:pb-7  ">
          <SummerFashionSubpageProductsRow1
            AddToCart={AddToCart}
            CardCounter={CardCounter}
            ModelBaskets={ModelBaskets}
          />
        </div>
        <div className=" lg:flex justify-end items-end pb-7  lg:pb-12 ">
          <SummerFashionSubpageProductsRow2
            AddToCart={AddToCart}
            CardCounter={CardCounter}
            ModelBaskets={ModelBaskets}
          />
