...
import StreetStyleFashionSubpageProductsRow1 from "./Product/StreetStyleFashionSubpageProductsRow1";
import StreetStyleFashionSubpageProductsRow2 from "./Product/StreetStyleFashionSubpageProductsRow2";
    ...
    <>
      ...
      <div className="w-4/5 lg:border-t-2 lg:border-LightBlack">
        <div className=" lg:flex justify-end items-end  lg:pb-7  ">
          <StreetStyleFashionSubpageProductsRow1
            AddToCart={AddToCart}
        ...
        <div className=" lg:flex justify-end items-end pb-7   ">
          <StreetStyleFashionSubpageProductsRow2
            AddToCart={AddToCart}
            CardCounter={CardCounter}
            ModelBaskets={ModelBaskets}
          />
